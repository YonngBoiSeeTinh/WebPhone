        ...
        <Routes>
         ...
         <Route path='/admin/' element={<AdminLayout isAdmin ={user.isAdmin} notity={notity} setNotify={setNotify}/>}>
              ...
              <Route path='orders' element={<OrderPage />} >
                 <Route path='nonAccept' element={<NonAcceptOrder setAlertMessage={setAlertMessage} setShowAlert={setShowAlert} setType={setType}
                                                  notity={notity} setNotify={setNotify} />} /> 
