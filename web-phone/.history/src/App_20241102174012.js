...
import Notify from './view/Admin/Notify/Notify';
    ...
    <div className="App">
      ...
      <Notify notity={notity}  num={num}/>
        <Routes>
         ...
         <Route path='/admin/' element={<AdminLayout isAdmin ={user.isAdmin} notity={notity} 
                                        setNotify={setNotify} setNum={setNum} num={num} />}>
