...
function AddressForm({ address, setAddress, handleSaveAddress }) {
    ...
    const [selectedProvince, setSelectedProvince] = useState(address.split[0]);
    const [selectedDistrict, setSelectedDistrict] = useState('');
    const [selectedWard, setSelectedWard] = useState('');
    const [detailAddress, setDetailAddress] = useState('');  // Trường "Chi tiết"
    ...
    const handleSave = () => {
        ...
        const wardName = wards.find(w => w.ward_name === selectedWard)?.ward_name || '';
