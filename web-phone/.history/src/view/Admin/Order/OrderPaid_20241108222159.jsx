...
const fetchApiProduct = async () => {
  ...
  const getWarrantyStatus = (updatedAt) => {
    ...
    updatedAtDate.setMonth(updatedAtDate.getMonth() + 6);
             ...
             <img src={getProduct(order.productId)?.image}/>
                 <div>
                   <div style={{display:"flex"}}>
                     <div className="proNameP">Tên sản phẩm</div>
                   ...
                   <div style={{display:"flex"}} >
                     <div className="proNameP" >{getProduct(order.productId)?.name}</div>
                     ...
                     <div className="proPrice" style={{color:"#e49516"}}>{order.totalPrice.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })}  </div>
                 </div>
                 </div>             
             </div>
         </div>
