            ...
            <div className="user-page">
                <div className="user-profile">
                    ...
                    <div className="user-info">
                        ...
                        <div className="table_row-header">Tên:</div>
                            <input className="table_row-infor" value={name} onChange={(e) => setName(e.target.value)} />
                        </div>
                        <div style={{ display: 'flex' }}>
                        <div className="table_row-header">Email:</div>
                ...
                <div className="account-details">
                    ...
                    <div className="account-table">
                        ...
                        <div className="account-table_row">
                           ...
                           < input className="table_row-infor" value={password} onChange={(e) => setPassword(e.target.value)} /> 
                        </div> 
