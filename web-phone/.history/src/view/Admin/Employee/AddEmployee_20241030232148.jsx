                ...
                <div className="user-profile">
                    ...
                    <div className="user-info" >
                        ...
                        <div className="table_row-header"  style={{background:"none"}}>Tên:</div>
                            <input className="table_row-infor" value={name} onChange={handleInputChange}
                            style={{minWidth:"400px"}} />
                        </div>
                        <div style={{ display: 'flex' }}>
                        <div className="table_row-header" style={{background:"none"}}>Email:</div>
                            <input className="table_row-infor" value={email} onChange={handleInputChange}
                             style={{minWidth:"400px"}}  />
                        </div>
                ...
                <div className="account-details">
                    ...
                    <div className="account-table">
                        ...
                        <div className="account-table_row">
                            ...
                            <input className="table_row-infor" value={phone} onChange={handleInputChange}  style={{width:"100%"}}/>       
                        </div>
                        <div className="account-table_row">
                            <div className="table_row-header">Địa chỉ:</div>
                            <input className="table_row-infor" value={address} onChange={handleInputChange} style={{width:"100%"}} />    
                        </div> 
                        <div className="account-table_row">
                            <div className="table_row-header">Mật khẩu:</div>
                           < input className="table_row-infor" type="password" value={password} onChange={handleInputChange} style={{width:"100%"}}/> 
                        </div> 
