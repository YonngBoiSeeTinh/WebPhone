...
function UserPage({ setAlertMessage,setShowAlert, setType }) {
    ...
    return (
        <div style={{height:"auto", marginTop:"130px " }}>
            <div className="user-page">
                ...
                <div className="timekeeping_container employee_timekeeping" style={{width:"60%"}}>
                    <div className="employee_timekeeping-select" style={{width:"110%"}}>
                        <h4>Chấm công </h4>
                        <input
                        type="date"/>
                    </div>
