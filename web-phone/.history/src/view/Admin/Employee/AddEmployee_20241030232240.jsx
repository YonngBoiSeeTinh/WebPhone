                ...
                <div className="account-details">
                    ...
                    <div className="account-table">
                        ...
                        <div className="account-table_row">
                            ...
                            <input className="table_row-infor" onChange={handleInputChange}  style={{width:"100%"}}/>       
                        </div>
                        <div className="account-table_row">
                        ...
                        <div className="account-table_row">
                           ...
                           < input className="table_row-infor" type="password"  onChange={handleInputChange} style={{width:"100%"}}/> 
                        </div> 
