...
const Header = ({isSignIn,setIsSignIn,setFilter,setAlertMessage,setShowAlert, setType}) => {
    ...
    const handleClickCart =()=>{
        if (!user.id) {
            setAlertMessage("Vui lòng đăng nhập để sử dụng dịch vụ ");
            setType("infor");
            setShowAlert(true);
        }
    }
            ...
            {showSignUp && (
                <div className="overlay">
                    <div className="signup-modal">
                        ...
                        <SignUp handleOpenLogin={handleOpenLogin} setAlertMessagen ={setAlertMessage} setShowAlert ={setShowAlert} setType ={setType} /> {/* Truyền hàm mở đăng nhap */}
                    </div>
                </div>
            )}
        </div>
