    ...
    <div className="cart-container">
      ...
      <div className="cart-form">
        ...
        <div className="cart-agreement">
          <label>
            <input type="checkbox" onClick={handleAccept()}/> Tôi đồng ý với <a href="#">Chính sách xử lý dữ liệu cá nhân</a> của GudPhoneStore
          </label>
        </div>

        <button className="order-button" value={isAccept?on:off} onClick={handleOrder}>Đặt hàng</button>
      </div>
    </div>
  );
};
