...
function Home ({filter}){
        ...
        return (
            ...
            <div className="home-container">
                ...
                <div className="contain-khungSanPham" style={{ display: filteredListProducts.length>0 ? 'none' : 'block' }}>
                ...
                <div className="contain-khungSanPham" style={{ display: filteredListProducts.length>0 ? 'block' : 'none' }}>
