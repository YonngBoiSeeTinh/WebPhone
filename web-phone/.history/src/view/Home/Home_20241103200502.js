        ...
        return (
            ...
            <div className="home-container">
                ...
                <div className="flexContain">
                    <FilterDropdown title="Giá tiền" priceRanges={priceRanges} onSelect={setPriceFilter}/>
                    <FilterDropdown title="Khuyến mãi" promotions={promotions} onSelect={setPromotionFilter}/>
                    <FilterDropdown title="Sắp xếp" sortOptions={sortOptions} onSelect={setSortOption}/>
                </div>
                <ChosenFilters />
