...
const ProductInfor =({ product ,handleColorClick,handleAddProduct,handleAccept})=>{
    const details = [
    ...
    return (
        <div className="product-info">
            ...
            <ProductPrice price= {product?.price
                                ? product.price.toLocaleString( { style: 'currency', currency: 'VND' })
                                : 'Loading...'} 
                                oldPrice={product.promo?.oldPrice ?
                                    product.promo?.oldPrice.toLocaleString({ style: 'currency', currency: 'VND' })
                                    :""
                                 }
                                value={product.promo?.value ?
                                    product.promo?.value.toLocaleString( { style: 'currency', currency: 'VND' })
                                    :""
                                 } />

            <PromoBox handleAddProduct ={handleAddProduct} handleAccept={handleAccept} ></PromoBox>
