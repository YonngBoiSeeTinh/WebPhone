    ...
    <div className="App">
      ...
      {(!isAdminPage && !isEmployeePage) && <TopNavigation />} {/* Hiển thị TopNavigation nếu không phải trang admin */}
        <Routes>
          ...
          <Route path='/product/:name' element={<ProductDetail setAlertMessage={setAlertMessage} setShowAlert={setShowAlert} />} />
      ...
      {showAlert && <Alter message={alertMessage} onClose={handleCloseAlert} />}
    </div>
  );
}
