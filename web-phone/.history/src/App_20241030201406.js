    ...
    <div className="App">
      ...
      {(!isAdminPage && !isEmployeePage) && <TopNavigation />} {/* Hiển thị TopNavigation nếu không phải trang admin */}
        <Routes>
         ...
         <Route path='/admin/' element={<AdminLayout isAdmin ={user.isAdmin} notity={notity} setNotify={setNotify}/>}>
              ...
              <Route path='customerDetail' element={<EmployeeDetail setAlertMessage={setAlertMessage}
                     setShowAlert={setShowAlert} setType={setType}/>} 
                />
          ...
          <Route path='/employee/' element={<EmployeeLayout isEmployee ={user.role === "employee"} user={user}/>}>
              ...
              <Route path='/employee/products/employee/product/:name' element={<EmployeeProductDetail />} ></Route>
