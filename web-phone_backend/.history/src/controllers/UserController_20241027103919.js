...
// Regex để kiểm tra name (6-20 ký tự, không có ký tự đặc biệt)
const nameRegex = /^[a-zA-ZÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚĂĐĨŨƠàáâãèéêìíòóôõùúăđĩũơƯĂẠẢẤẦẨẪẬẮẰẲẴẶẸẺẼỀỀỂưăạảấầẩẫậắằẳẵặẹẻẽềềểếếệỄỆỉịọỏốồổỗộớờởỡợụủứừửữựỳỵỷỹ\s]{6,20}$/;
const isValidName = nameRegex.test(name);

// Regex để kiểm tra password (8-20 ký tự, ít nhất 1 chữ hoa, 1 chữ thường, và 1 số)
